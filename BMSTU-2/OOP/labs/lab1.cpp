/*
Пример входных данных для программы
1
-1
0
1
...
// Функции, возвращающие коорданаты пересечения прямых
